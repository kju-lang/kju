namespace KJU.Tests.Util
{
    ...
    public class InverseRelationHelperTests
    {
        ...
        {
            var relation = new Dictionary<int, List<int>> { [0] = new List<int>(), [5] = new List<int>() };
        ...
        public void NontrivialRelationTest()
        {
            ...
            {
                [0] = new List<int> { 0, 1, 1, 4, 5 },
                [4] = new List<int> { 1, 4 },
                [5] = new List<int> { 6, 1, 2 }
            };
            ...
            var element = new[] { 0, 1, 2, 4, 5, 6 };
            var expectedSecondElements = new[]
            {
                "0",
                "0,4,5",
                "5",
            ...
            for (var i = 0; i < 6; ++i)
            {
                ...
                Assert.AreEqual(expectedSecondElements[i], secondElements, $"Second elements are not equals at {i}.");
            }
        }
    }
}