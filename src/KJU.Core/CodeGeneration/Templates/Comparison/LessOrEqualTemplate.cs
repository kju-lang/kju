...
namespace KJU.Core.CodeGeneration.Templates.Comparison
{
    ...
    public class LessOrEqualTemplate : InstructionTemplate
    {
        public LessOrEqualTemplate()
            : base(new Intermediate.Comparison(null, null, ComparisonType.LessOrEqual), 1)
        {
        }
        ...
        public override Instruction Emit(VirtualRegister result, IReadOnlyList<object> fill, string label)
        {
            ...
            return new LessOrEqualInstruction(lhs, rhs, result);
        }

        private class LessOrEqualInstruction : Instruction
        {
            private readonly VirtualRegister lhs;
            private readonly VirtualRegister rhs;
            private readonly VirtualRegister result;

            public LessOrEqualInstruction(
                VirtualRegister lhs,
                VirtualRegister rhs,
